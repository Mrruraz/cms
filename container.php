...
<body>
  ...
  <nav class="w3-sidebar " style="background-color:#F5F5F5;z-index:3;width:300px;margin-top:50px;" id="mySidebar"><br>
    ...
    <div class="w3-bar-block">
        ...
        <a href="container.php" class="w3-bar-item w3-button w3-padding w3-blue"><i class="fa fa-truck fa-fw"></i> Container</a><br><br>
...
<div class="w3-collapse w3-white w3-animate-left" style=" height: 100%; position: fixed;margin-left: 300px;top:50px;width: 350px; ">
  <div class="w3-bar-block" style="padding-top:47px;">
    <a href="Add_container.php" class="w3-bar-item w3-hover-blue w3-button w3-padding ">	&nbsp;	&nbsp;	&nbsp;	&nbsp;Add Container</a>
    <a href="Container_view.php"  class="w3-bar-item w3-hover-blue w3-button w3-padding ">	&nbsp;	&nbsp;	&nbsp;	&nbsp;View Container</a>
 </div>
</div>
